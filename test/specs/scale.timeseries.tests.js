...
//
	describe('when given inputs of different types', function() {
		...
		it('should accept labels as strings', function() {
			...
			expect(scale.ticks).toEqual(['Jan 1, 2015', 'Jan 2, 2015', 'Jan 3, 2015', 'Jan 5, 2015', 'Jan 7, 2015', 'Jan 8, 2015', 'Jan 10, 2015']);
		});
		...
		it('should accept data as xy points', function() {
			...
			expect(xScale.ticks).toEqual(['Jan 1, 2015', 'Jan 2, 2015', 'Jan 3, 2015', 'Jan 5, 2015', 'Jan 7, 2015', 'Jan 8, 2015', 'Jan 10, 2015']);
		});
	});
	...
	it('should build ticks using the config unit', function() {
		...
		expect(scale.ticks).toEqual(['Jan 1, 8PM', 'Jan 2, 9PM']);
	});
	...
	it('build ticks honoring the minUnit', function() {
		...
		var scale = createScale(mockData, config);
		expect(scale.ticks).toEqual(['2015', '2016']);
	});
	...
	it('should build ticks using the config diff', function() {
		...
		expect(scale.ticks).toEqual(['Dec 28, 2014', 'Feb 1, 2015', 'Feb 15, 2015']);
	});
	...
	it ('Should get the correct pixel for a value', function() {
		...
		var xScale = chart.scales.xScale0;
		expect(xScale.getPixelForValue(0, 0, 0, false)).toBeCloseToPixel(34);
		expect(xScale.getPixelForValue(0, 0, 0, true)).toBeCloseToPixel(34);
		expect(xScale.getValueForPixel(33)).toBe(0);

		expect(xScale.getPixelForValue(0, 4, 0, false)).toBeCloseToPixel(477);
		expect(xScale.getPixelForValue(0, 4, 0, true)).toBeCloseToPixel(477);
		...
		expect(xScale.getPixelForValue(0, 4, 0, false)).toBeCloseToPixel(389);
		expect(xScale.getPixelForValue(0, 4, 0, true)).toBeCloseToPixel(433);
